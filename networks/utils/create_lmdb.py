...
from networks.utils import scandir
from networks.utils.lmdb_util import make_lmdb_from_imgs
...
def create_lmdb_for_realblurJ():
    folder_path = './datasets/RealBlur-J/train/blur_crops'
    lmdb_path = './datasets/RealBlur-J/train/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/RealBlur-J/train/sharp_crops'
    lmdb_path = './datasets/RealBlur-J/train/sharp_crops.lmdb'
...
def create_lmdb_for_realblurR():
    folder_path = './datasets/RealBlur-R/train/blur_crops'
    lmdb_path = './datasets/RealBlur-R/train/blur_crops.lmdb'

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = './datasets/RealBlur-R/train/sharp_crops'
    lmdb_path = './datasets/RealBlur-R/train/sharp_crops.lmdb'
